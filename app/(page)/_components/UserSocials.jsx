...
<>
  <div className="grid place-content-center mb-14 text-center gap-1 px-2">
   ...
   <p
  className="text-sm dark:text-gray-400 text-gray-600 max-w-[320px] mx-auto sm:line-clamp-2 line-clamp-none"
>
  ...
  {loding && (
                    <Skeleton className="h-8 mb-5 w-40 mx-auto" />
                )}
                {loding && (
                    <Skeleton className="h-14 mb-5 w-[300px] mx-auto" />
                )}
      ...
      {!loding && (
        ...
        <div className="grid relative gap-3 grid-cols-1 max-w-[600px]">
          ...
          {(linkedin || github || reddit || stackoverflow || leetcode || codeforces || hackerrank || codechef || geeksForGeeks) && (
            <>
            ...
            <>
              <div className="w-full gap-2 md:w-[420px] sm:w-[300px] font-semibold mx-auto h-14 flex items-center justify-center relative dark:text-white">
                <img
                  ...
                  draggable="false"
                />
                <h2 className="text-base text-gray-500  text-[12px]">Storefront/Donations</h2>
              </div>
    ...
    {showPrivate && (
      ...
      {error && (
        <div className="-mt-20 mb-20 grid place-content-center">
          ...
          <Button href="https://mysocialz.vercel.app/" className="mt-5 w-full max-w-sm mx-auto">Back</Button>
        </div>
      )}
      <div className="mt-32 grid place-content-center text-center -mb-10">
        ...
        {error ? (
          ...
          <p className="text-xs mt-2 text-[13px]">
            All rights reserved by {userDataName} with <a href="/">MySocials.</a>
          </p>
        )}
      </div>
