    ...
    return (
        <div className="py-14 px-6 md:px-20 lg:px-32 grid">
            ...
            <div className="grid sm:place-content-center sm:text-center gap-2">
                ...
                <p className="md:text-base text-xs max-w-sm md:max-w-xl sm:text-center sm:mx-auto dark:text-gray-400 text-gray-600">Simplify and elevate your online presence effortlessly with MySocials, where one link connects to endless opportunities.</p>
            </div>
            <div className="flex items-center sm:justify-center gap-3 mt-7">
